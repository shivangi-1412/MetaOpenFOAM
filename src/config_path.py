...
config2_yaml_path = os.path.join(MetaGPT, "config/config2.yaml")
...
new_config2_data = {
    "llm": {
        "api_type": "openai",
        "model": model,
        "proxy": os.environ.get('OPENAI_PROXY') if os.environ.get('OPENAI_PROXY') != "XXX" else None,
